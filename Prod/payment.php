...
<?php
    ...
    $insert_query = "INSERT INTO transactions VALUES ('" . $transaction_id . "','" . $user_id . "','" . $productid . "','" . $order_id . "', 'FALSE', 'FALSE', CURRENT_TIMESTAMP);";
    if($conn->query($insert_query)!==TRUE) {
        die('Could not initiate transaction');
    }
    $display = 'none';
?>
<script src="https://www.paypal.com/sdk/js?client-id=AU-7GHml2FvLkHJmlr50T8QliuLeHu2CXgygIAOYV7Sy8NWM0cJ1Hu3vrvUisBL36yM34r5JVa2mtQol"></script>
<script>
    paypal.Buttons({
        ...
        alert("Seems like you have cancelled the order. Kindly visit https://www.wrapyourbook.com/support for clarification");
